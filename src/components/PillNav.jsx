...
const PillNav = ({
  ...
  showLogo = true,
  navBackground, // optional: override nav background (e.g., 'transparent')
  navHeight = 54
}) => {
  ...
  const cssVars = {
    ...
    '--nav-h': typeof navHeight === 'number' ? `${navHeight}px` : navHeight,
    '--logo': '36px',
    '--pill-pad-x': '18px',
    '--pill-gap': '3px'
  };
  ...
  return (
    <div className="relative z-[1000] w-full">
      ...
      <div
        ref={mobileMenuRef}
        className="md:hidden absolute left-2 right-2 rounded-[27px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] z-[998] origin-top"
        style={{
          ...cssVars,
